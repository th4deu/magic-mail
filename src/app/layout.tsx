...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Crie um email temporario gratis em ${domain}. Receba emails de confirmacao sem spam. Receba feedbacks anonimos, mensagens secretas e confissoes. Ideal para testes de sites, cadastros em promocoes e caixa de sugestoes. Sem cadastro, sem senha, 100% privado.`,
    keywords: [
      // Email temporário
      'email temporario',
      'email descartavel',
      ...
      'email temporario para sites',
      'email para cadastro',
      'email para promocoes',
      'email para newsletters',
      'caixa de sugestoes anonima',
...
export default async function RootLayout({
  ...
  const jsonLd = {
    ...
    featureList: [
      ...
      'Email para cadastros em promocoes',
      'Confissoes e perguntas secretas',
      'Protecao contra spam',
      'Multiplos dominios disponiveis',
    ],
    author: {
      '@type': 'Organization',
      name: 'UAISE',
